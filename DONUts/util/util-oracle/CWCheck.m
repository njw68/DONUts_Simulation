%Oracle CWCheck
function [bots,world,moves] = CWCheck(bots,world,I,bot_rotate,C_rotateX,C_rotateY,bot,ang,moves,both,magpos)
    minBotDist = 1.9714;
    ...
    %creates the CW checked regions
    ...
    %add all obstacle points to an array
    ObsAll = [];
